...
function TabsTrigger({ className, ...props }: TabsPrimitive.Tab.Props) {
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        controlRounded,
        "relative inline-flex flex-1 items-center justify-center gap-1.5 border-none bg-transparent px-4 py-2 text-[13px] font-medium whitespace-nowrap text-text-dim transition-colors cursor-pointer group-data-vertical/tabs:w-full group-data-vertical/tabs:justify-start hover:bg-accent-green/15 hover:text-accent-green-dim data-active:bg-accent-green/15 data-active:font-semibold data-active:text-accent-green-dim focus-visible:outline-none focus-visible:ring-0 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
